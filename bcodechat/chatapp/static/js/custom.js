...
async function postJSON(data) {
    ...
    try {
      ...
      //   The below 2 lones cause errors because you already removed the elements index.html
      ...
      <div class="bot-chat-container" style="background-color: #f0f0f0; color: #333">
...
function submitForm(e){
    ...
    console.log("Sumbission in progress...")
